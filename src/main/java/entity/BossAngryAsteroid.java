...
/**
 * Class that represents an Angry Asteroid Boss.
 * Moves like a saucer from one side of the
 * screen to the other until it's killed.
 * @author Dario
 *
 */
public class BossAngryAsteroid extends AbstractEntity {
	...
	public BossAngryAsteroid(final float x, final float y,
	...
	/**
	 * Calculate new position of BossAngryAsteroid, get it to shoot,
	 * get it to change direction and if it hits the wall get it to turn back.
	...
	/**
	 * Change the boss's direction randomly at certain times in a random direction.
	 */
	...
	/**
	 * Causes the BossAngryAsteroid to turn around when it reaches the edge of the screen.
	 */
	...
	@Override
	public void collide(AbstractEntity e2) {
