...
public class Game {
	...
	private final double[] ScoreDisplayX = { 190, 200, 190, 200, 190, 200 }; // first
																				// one
																				// only
	private final double[] ScoreDisplayY = { 20, 20, 30, 30, 40, 40 };

	private final int[][] NumberLines = { { 0, 1, 5, 4, 0 }, { 1, 5 }, { 0, 1, 3, 2, 4, 5 }, { 0, 1, 3, 2, 3, 5, 4 },
			{ 0, 2, 3, 1, 5 }, { 1, 0, 2, 3, 5, 4 }, { 1, 0, 4, 5, 3, 2 }, { 0, 1, 5 }, { 2, 0, 1, 5, 4, 2, 3 },
			{ 4, 5, 1, 0, 2, 3 } };
